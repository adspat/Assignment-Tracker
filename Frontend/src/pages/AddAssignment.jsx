  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data.success || data._id) {
        ...
        setFormData({
          title: "", semester: "", classs: "",
          subject: "", branch: "", submissionDate: "", description: "",
        });
      }
    } catch (error) {
      console.log(error);
      const errorMsg = error.response?.data?.message || "Submission failed. Please review the form and try again.";
