      ...
      <div className="w-full max-w-2xl bg-white border-[#34473c] border-t-4 sm:border-t-[6px] shadow-xl rounded-2xl flex flex-col overflow-hidden max-h-[96dvh]">
        ...
        <header className="px-4 sm:px-6 py-4 border-b border-[#34473c]/15 flex items-start sm:items-center justify-between gap-3 bg-white shrink-0">
          <div className="min-w-0">
            <p className="text-[10px] font-bold tracking-[0.15em] text-[#09050f]/60 uppercase mb-0.5">
          ...
          <div className="flex flex-col-reverse sm:flex-row items-stretch sm:items-center justify-between gap-3 border-t border-[#34473c]/15 pt-4 mt-4 bg-white shrink-0">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                type="submit"
                disabled={loading}
                className="flex-1 sm:flex-none px-5 py-2.5 bg-[#f76605] cursor-pointer hover:bg-[#27352d] disabled:bg-[#09050f]/40 text-white text-xs font-bold tracking-wide rounded-lg shadow-md hover:shadow-lg transition-all flex items-center gap-2 min-w-[150px] justify-center cursor-pointer"
              >
                {loading ? (
                  <>
        ...
        {/* Global Footer */}
        <div className="px-4 sm:px-6 py-2.5 bg-[#09050f]/5 border-t border-[#34473c]/15 flex items-center justify-between text-[10px] text-[#09050f]/60 font-medium shrink-0">
